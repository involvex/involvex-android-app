  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: "3rem" }}>
        <a
          href="https://github.com/involvex/involvex-android-app"
          style={{
            padding: "1rem 1rem",
        ...
        <a
          href="https://involvex.github.io/involvex-android-app/"
          style={{
            padding: "1rem 1rem",
      ...
      >
        ...
        <p style={{ margin: "1rem 0", color: "var(--color-text-grey)" }}>
          Get the Android app to track trending repositories and packages on the
          go
        </p>
        <a
